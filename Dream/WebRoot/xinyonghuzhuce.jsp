...
<section class="p-component-usercenter clearfix">
    <div class="sidebar s_ani help-sidebar" >
        ...
        <ul class="list-unstyled help">
            ...
            <li>
                <a href="xinyonghuzhuce.jsp"  class="cur"> 新用户注册</a>
    ...
    <div class="main help-main">
        ...
        <div class="help-main-content">
            <p>&nbsp;注册当然果园会员</p>
<p>&nbsp;</p>
<div>1、打开当然果园官方网站首页，点击右上方的&ldquo;注册&rdquo;。</div>
<div><img src="img/help_newuser1.jpg" width="164" height="29" alt="" /></div>
<div>&nbsp;</div>
<div>2、进入&ldquo;新用户注册&rdquo;页面，输入手机号，点击&ldquo;获取验证码&rdquo;进行手机验证。</div>
<div><img src="img/help_new_zc1.png" width="698" height="460" alt="" /></div>
<div>&nbsp; 3、输入正确的验证码后，进行您的账户密码设置，完成后点击&ldquo;注册&rdquo;。</div>
<div>
<div>&nbsp;</div>
<div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
</div>
