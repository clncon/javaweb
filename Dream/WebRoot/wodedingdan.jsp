...
<jsp:include page="console_element/top2.jsp"></jsp:include>
	...
	<li>
		<a href="OrdersServlet?todo=searchOrders2" class="cur" >我的订单</a><a href="./wodejifen.jsp" >我的积分</a>
	...
	<li>
        ...
        <div class="main">
            <div class="tabmenu" id="uctabnav">
                <ul class="list-unstyled">
                    <li  ><a href="OrdersServlet?todo=searchOrders2" class="link"><span>所有订单</span><i class="interval">|</i></a></li>
                    <li  ><a href="OrdersServlet?todo=searchOrders2ByStatus&oStatus=未完成" class="link"><span>未完成</span> <i class="interval">|</i></a></li>
                    <li  ><a href="OrdersServlet?todo=searchOrders2ByStatus&oStatus=已取消" class="link"><span>已取消</span> <i class="interval">|</i></a></li>
                    <li  ><a href="OrdersServlet?todo=searchOrders2ByStatus&oStatus=已收货" class="link"><span>已收货</span> <i class="interval">|</i></a></li>
              ...
              <table>
                ...
                <tr> 
                   ...
                   <th>${Ougp.gPrice*Ougp.pNum}</th>
                    <th>${Ougp.oStatus }</th>
                    <th>
                    <a href="OrdersServlet?todo=searchupdateOrders2&oid=${Ougp.oId}&oStatus=未完成">未完成</a>
                    <a href="OrdersServlet?todo=searchupdateOrders2&oid=${Ougp.oId}&oStatus=已取消">已取消</a>
                    <a href="OrdersServlet?todo=searchupdateOrders2&oid=${Ougp.oId}&oStatus=已收货">已收货</a>
                    </th>
                </tr>
                 </c:forEach>
                               </table>
