...
<section class="p-component-usercenter clearfix">
    <div class="sidebar s_ani help-sidebar" >
        ...
        <ul class="list-unstyled help">
            ...
            <li>
                ...
                <a href="yanhuoyuqianshou.jsp"  class="cur" >验货与签收</a>
            </li>
            <li>
    ...
    <div class="main help-main">
        ...
        <div class="help-main-content">
            <p>&nbsp;1. 验货须知：</p>
<div>&nbsp;</div>
<div>①请您务必小心开包，以免尖锐物件损伤到包裹内的产品。</div>
<div>&nbsp;</div>
<div>②签收时仔细核对：请您对产品品类、数量进行检查，若包装破损、商品错误、商品少发、商品存在质量问题等，</div>
<div>请您立即联系当然果园客服，我们将会为您及时处理。</div>
<div>&nbsp;</div>
<div>2. 以下情况可以拒收:</div>
<div>&nbsp;</div>
<div>①商品存在质量问题；</div>
<div>&nbsp;</div>
<div>②发错商品、商品数量有误、尺码有误等；</div>
<div>&nbsp;</div>
        </div>
    </div>
</section>
