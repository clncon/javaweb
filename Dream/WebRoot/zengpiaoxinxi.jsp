...
<section class="p-component-usercenter clearfix">
    <div class="sidebar s_ani help-sidebar" >
        ...
        <ul class="list-unstyled help">
            ...
            <li>
                ...
                <a href="zengpiaoxinxi.jsp"   class="cur"  >增票信息</a>
    ...
    <div class="main help-main">
        ...
        <div class="help-main-content">
            <p>账户：福建厦门当然鲜果电子商务有限公司</p>
<div>开户行：中国农业银行&nbsp;</div>
<div>账号： 3100 1556 2000 5000 9114</div>
<div>经营地址:福建省厦门市思明区莲前街水果园二期望海路71号楼907室</div>
<div>&nbsp;</div>
<div>公司联系电话：18060302277</div>
<div>税号：310115557452741 &nbsp;</div>
        </div>
    </div>
</section>
